...
<head>
  ...
  <link rel="stylesheet" href="/css/Wattson.css">
...
<body>
          ...
          <fieldset id="game-info">
            ...
            <div>
              <table data-color='RED'>
                <tr>
                  <td><img src="../img/chessback.png" /></td>
                  <td class="name">Red</td>
                </tr>
              </table>
              <table data-color='WHITE'>
                <tr>
                  <td><img src="../img/images-2021-09-11T082939.336.png" /></td>
  ...
  <audio id="audio" src="http://www.soundjay.com/button/beep-07.mp3" autostart="true" ></audio>
